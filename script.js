...
const translations = {
  ru: {
    ...
    "portfolio.e.desc": "Крипто-игровая платформа нового поколения: быстрые, безопасные и immersive-ставки для глобального сообщества игроков.",
    "portfolio.e.industry": "Gambling / Online Gaming",
    "portfolio.e.tech": ".NET, RabbitMQ, Vue.js, Redis, Serilog, MongoDB, SQL Server, Modern Betting Logic",
    "portfolio.e.value": "Бесшовная высокопроизводительная среда для ставок с real-time wagering, масштабируемым backend, безопасной обработкой транзакций и вовлекающим UX. Рассчитана на большие объёмы игроков с упором на надёжность, скорость и непрерывный геймплей.",
    "portfolio.e.alt1": "EpicCasino — платформа на desktop, mobile и wearable",
    "portfolio.e.alt2": "EpicCasino — мобильные интерфейсы спортивных ставок и казино",
    "portfolio.e.alt3": "EpicCasino — слоты, спорт и live casino в одном приложении",
    ...
    "stack.enterprise": "Enterprise & ERP",
    "stack.integrations": "Integrations & Messaging",
  ...
  en: {
    ...
    "portfolio.e.desc": "Next-generation crypto gaming platform delivering fast, secure, and immersive betting experiences for a global community of players.",
    "portfolio.e.industry": "Gambling / Online Gaming",
    "portfolio.e.tech": ".NET, RabbitMQ, Vue.js, Redis, Serilog, MongoDB, SQL Server, Modern Betting Logic",
    "portfolio.e.value": "Provides a seamless and high-performance betting environment with real-time wagering, scalable backend architecture, secure transaction processing, and engaging user experiences. Designed to support large player volumes while ensuring reliability, speed, and uninterrupted gameplay.",
    "portfolio.e.alt1": "EpicCasino multi-device betting platform",
    "portfolio.e.alt2": "EpicCasino mobile sports betting and casino interfaces",
    "portfolio.e.alt3": "EpicCasino slots, sports, and live casino in one app",
